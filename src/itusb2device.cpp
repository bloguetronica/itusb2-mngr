...
quint8 ITUSB2Device::getMajorRelease(int &errcnt, QString &errstr) const
{
...
quint8 ITUSB2Device::getMaxPower(int &errcnt, QString &errstr) const
{
    return cp2130_.getMaxPower(errcnt, errstr);
}

// Gets the minor release version from the device
quint8 ITUSB2Device::getMinorRelease(int &errcnt, QString &errstr) const
{
