This package contains all the necessary files and scripts to install ITUSB2
Manager (a standalone graphical application that is used to control the ITUSB2
...
In order to compile and install ITUSB2 Manager for the first time, all you
...
application and source code. However it won't remove the "build-essential",
"libusb-1.0-0-dev" and "qt5-default" packages, since they could be already
installed before the first installation.
